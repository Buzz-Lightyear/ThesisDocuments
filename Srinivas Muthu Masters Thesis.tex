...
\chapter{Data Analysis and Results}
		...
		\section{Demographic Data}
			...
			So far, we've analyzed the distribution for the number of installed applications, the number of unique applications clicked and the total number of calendar entries during the course of the experiment. In the next section, we'll examine the CHR(s) of each caching scheme and whether there's a correlation between these metrics and the efficiency of certain caching schemes.
		...
		\section{Experiment Results}
			...
			Let us analyze the data from each scheme. Since the absolute number of cache hits and cache misses vary depending on frequency of smart-phone usage, the only relevant metric is the CHR for each scheme. We'll examine the CHR(s) in percentages for each caching scheme.
