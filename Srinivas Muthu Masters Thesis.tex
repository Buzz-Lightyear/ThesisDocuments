...
\chapter{Experiment Setup and Application Design}
	...
	\section{Eligibility for Volunteers}
		...
		\begin{itemize}
			...
			\item The volunteer must be willing to install two third party applications on their APMD, each for the duration of one week.
		\end{itemize}
