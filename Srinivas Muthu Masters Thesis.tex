...
\chapter{Data Analysis and Results}
		...
		\section{Experiment Results}
			...
			\subsection{Context Scheme}
				...
				\begin{figure}[h]
					...
					\caption[Distribution of CHR for Context Scheme]{This scatter plot illustrates the distribution for the CHR(s) in the context scheme, among the 20 volunteers. It is worth noting that 25\% of the volunteers had a CHR of 14.05\% or less i.e. the Q1 value is 14.05\%. Similarly, 75\% of the volunteers had a CHR of 20.68\% or below indicating that the third quartile value or Q3 is 20.68\%. On a side note, this scatter plot was generated using Minitab, a statistical software package [64].}
				\end{figure}
			...
			\subsection{Default Scheme}
				...
				\begin{figure}[h]
					...
					\caption[Distribution of CHR for Default Scheme]{This scatter plot illustrates the distribution for the CHR(s) in the default scheme, among the 20 volunteers. It is worth noting that 25\% of the volunteers had a CHR of 70.28\% or less i.e. the Q1 value is 70.28\%. Similarly, 75\% of the volunteers had a CHR of 89.34\% or below indicating that the third quartile value or Q3 is 89.34\%. This scatter plot was generated using Minitab as well [64].}
				\end{figure}
			...
			\subsection{Default-Context Hybrid Scheme}
				...
				\begin{figure}[h]
					...
					\caption[Distribution of CHR for Hybrid Scheme]{This scatter plot illustrates the distribution for the CHR(s) in the hybrid scheme, among the 20 volunteers. It is worth noting that 25\% of the volunteers had a CHR of 73.97\% or less i.e. the Q1 value is 73.97\%. Similarly, 75\% of the volunteers had a CHR of 92.73\% or below indicating that the third quartile value or Q3 is 92.73\%. This scatter plot was generated using Minitab as well [64].}
				\end{figure}
		...
		\section{Significance Testing}
			...
			\begin{figure}[h]
				...
				\caption[Relative Increase in CHR - Chart]{This scatter plot illustrates the increase in CHR from the default to hybrid scheme for each of the 20 volunteers.}
			\end{figure}
			...
			The null hypothesis refers to a general statement or a default position that there is no relationship between two measured phenomena [67]. In our case, the null hypothesis would state that the increase in CHR is purely due to sampling error and therefore statistically insignificant. Our objective is to disprove or reject the null hypothesis by performing a paired t test. Significance level is the probability of rejecting the null hypothesis given that it is true [68]. By convention, the significance level is set to 0.05 (5\%), implying that it is acceptable to have a 5\% probability of incorrectly rejecting the null hypothesis. The {\em p-value} is defined as the probability of obtaining a result equal to or more statistically extreme than what was actually observed, assuming that the null hypothesis is true [69]. Therefore, if the paried t test produces a p-value lesser than the significance level i.e. the probability of obtaining more extreme results is lesser than the probability of incorrectly rejecting the null hypothesis, then the results are statistically significant and the null hypothesis can be rejected. The results of the paired t test are shown in Figure 5-9.
			...
			Given that the {\em p-value} (0.00) is lesser than the significance level (0.05), the null hypothesis can be rejected. Therefore, the increase in CHR between the two caching schemes is not due to sampling error and is statistically significant. In the next section, we'll examine potential correlations between the cache hit ratios and some of the demographic data.
			
		\section{Correlation with Demographic Data}
			Intuitively, we'd expect the increase in CHR to be higher when the calendar usage is higher. Let us examine if such a correlation exists is the data we collected. We compute the Pearson product-moment correlation coefficient (PPMCC) for the increase in CHR and the number of calendar entries for each volunteer (Refer Figure 5-10). 
			
			\begin{figure}[h]
				\centering
				\includegraphics[width = 70mm]{images/calendarData.png}
				\caption[Increase in CHR vs Calendar Entries]{This table illustrates the data used to compute the correlation between increase in CHR and the number of calendar entries entered by each volunteer for the duration of the experiment.}
			\end{figure}
			
			PPMCC is a measure of the linear correlation between two variables X and Y, giving a value between +1 and −1 inclusive, where 1 is total positive correlation, 0 is no correlation, and −1 is total negative correlation [69]. In our case, a PPMCC value of 0.467 was obtained (using Minitab [64]) which signifies a moderate to strong positive correlation. Therefore, it is reasonable to conclude the increase in CHR from the default to hybrid scheme is consistent with an increase in calendar usage among the test subjects.
			
%		increase in CHR and calendar usage
%		default CHR and number of unique applications
