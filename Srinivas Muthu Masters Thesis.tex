...
\chapter{Introduction}
	...
	\section{Proposed Solution}		
		...
		\subsection{Assumptions}	
			...
			\begin{itemize}
				\item Android provides a public interface to read the user's calendar with their permission [30]. Therefore it's quite simple to obtain this information.
