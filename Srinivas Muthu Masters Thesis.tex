...
\chapter{Scope for Future Work}
	...
	\section{Scope for Improvement}
		...
		\subsection{Alternate Ways of Using the Contextual Information}
			
			\subsubsection{Switching to Silent Mode}
			
			\subsubsection{Disabling Texting at High Speeds}
		
		\subsection{Implementing the Hybrid Cache}
