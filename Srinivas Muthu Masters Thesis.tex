...
\chapter{Data Analysis and Results}
		...
		\section{Introduction}
%			chapter 3 - challenges in collecting the desired data - previous chapter - exp setup and design - this chapter we'll analyze the data collected for each scheme and compare efficiencies. first demographic data to get an idea about volunteers, then cache metrics data, significance testing to see if increase is significant, points of weaknesses
...
%				\item Android OS Version
%			\end{itemize} 
%			average for each, charts, point about OS Version
		\section{Experiment Results}
%			3 schemes - average for each scheme, charts for each - why context alone is bad and expected - increase in hybrid - looks good but is it significant? - potentially correlation between calendar usage and increase in ratio - other correlations
		\section{Significance Testing}	
%		paired t test - rejecting the null hypothesis - whether results are significant
		\section{Points of Weakness}		
%			there are certain factors that could decrease the value of this thesis - calendar not enough as not everything is covered by calendar, involve other context info - change in calendar events within 4 hr period not detected - too similar a demographic - theoretically volunteer bias - instructed not to close, not enforced, choosing time periods may theoretically affect data.
