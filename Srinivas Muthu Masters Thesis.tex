		...
		\subsection{Obtaining the Foreground Application}
			...
			\begin{algorithm}[H]
				...
				\For{File file : files}
				{
					...
					\If{LOWEST oomScore AND oomAdj NOT 0}{RETURN cmdline}
				}
				
				\caption{Algorithm to get current foreground application}
			\end{algorithm}
