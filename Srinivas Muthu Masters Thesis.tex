...
\chapter{Scope for Future Work}		
	...
	\section{Improving Context Analysis}
		...
		\subsection{Use frequency for user as default instead of most popular in America}
		
		\subsection{Other Ways of Gathering User Behavior Data}
		
		\subsection{Custom Priorities in Hybrid Cache}
		% If 'call' was parsed from Calendar, then dialer app is high priority followed by default followed by other call apps.
